...
class ColorList:
    cList = [
        ...
        Color((1.0, 0.58, 0.0, 1.0), 0.4, ["muscle_transparent"]),
        ...
        Color((0.69, 0.32, 0.87, 1.0), 1.0, ["safezone"]),
    ]
